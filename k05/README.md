...
## ソースコードの説明
　深さ優先探索では、まずvisitedを初期化して出発点をスタックにpushする。スタックが空になっているかを確認し、もしも空ならば終了する。そうでなければスタックから１つ取り出して行ったことがあるところかを確認する。行ったことがなければ、その場所に行ったことにし、その場所からいける場所をスタックに入れる。その後スタックが空になっているかを確認するを繰り返す。

　幅優先探索では、まずvisitedを初期化して出発点をキューに入れる。キューが空になっているかを確認し、もしも空ならば終了する。そうでなければキューから一つ取り出して行ったことがあるとことかを確認する。行ったことがなければ、その場所に行ったことにし、その場所からいける場所をキューに入れる。その後キューが空になっているかを確認するを繰り返す。
